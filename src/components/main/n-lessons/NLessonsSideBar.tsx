...
import { N_LESSONS_SIDEBAR_MENUS } from "../../config/PageConfig";
import "../../../styles/Sidebar.css";
import { DOC_TITLE, LOCAL_STORAGE } from "../../../types/constant";
import NLessonsMainHeader from "./NLessonsMainHeader";
...
const NLessonsSideBar = ({ activeItem, breadcrumbs, renderContent }: any) => {
  ...
  useEffect(() => {
    ...
    const loadAndScroll = async () => {
      ...
      setNLessonsCollapsedGroups(savedGroups);
          ...
          <header className="bg-gray-800 border-b border-gray-700 shadow-md">
            <div className="p-4 flex items-center">
              ...
              <div className="flex-1">
                <NLessonsMainHeader breadcrumbs={breadcrumbs} />
              </div>
            </div>
          </header>
...
export default NLessonsSideBar;
